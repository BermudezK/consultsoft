...
class VentanaLogin(QDialog):
  ...
  def submitAcceder(self):
    ...
    if usuario:
      ...
      print(usuario_id, username, personal_dni,
            rol_id, nombre_rol, nombre, apellido)
      QMessageBox.information(
          self, f"Bienvenido {apellido}, {nombre}. Rol {nombre_rol}", QMessageBox.Discard)
    #else:
      #QMessageBox.warning(self,"Ingreso", "Error al ingresar")
