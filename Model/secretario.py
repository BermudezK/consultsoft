...
from Model.secretario_query import insertarPaciente, pacienteExiste, obtenerMedicos,obtenerMedico, obtenerPacientes, existe,existe2, agregar_turno,existe_turno, getPaciente, modificar_paciente
